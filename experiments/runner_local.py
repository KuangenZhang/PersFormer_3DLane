...
class Runner:
    ...
    def reduce_all_loss(self, args, loss_list, loss, loss_3d_dict, loss_att_dict, num):
        ...
        reduced_prob_loss = reduced_prob_loss
        ...
        reduced_reg_loss = reduced_reg_loss
        ...
        reduce_2d_vis_loss = reduce_2d_vis_loss
        ...
        reduced_2d_cls_loss = reduced_2d_cls_loss
        ...
        reduced_2d_reg_loss = reduced_2d_reg_loss
